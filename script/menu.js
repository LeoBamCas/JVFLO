class Menu extends Phaser.Scene{
    ...
    create(){
        ...
        this.maison = this.physics.add.image(100,70,'maison') //ajout des lieux puis du groupe batiments
    ...
    movePlayer(){     //Fonction pour gerer les mouvements et animations du joueur
        var playerTexture = this.player.texture.key; //on crée une variable qui vient chercher le nom du spritesheet en cours du joueur, pour ensuite adapter son animation
